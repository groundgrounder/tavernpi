...
// core schema 是 v1 migration；卡包 schema.sql 后续以「注册额外命名 migration」接入，
// 与 core 迁移同表（schema_migrations）追踪，保证幂等与顺序。

import { DatabaseSync } from "node:sqlite";
import { CORE_SCHEMA_SQL } from "./schema.ts";
